...
public class JavaTask extends InterceptorAbstractTask {
    ...
    public void runTask() throws Exception {
        this.javaRequest = clientJob.getJavaRequest();
        this.clientRequest = (BasicClientRequest) this.javaRequest;
    ...
    private String buildCommand() throws Exception {
        ...
        //자바 옵션
        buildJavaOpts(command, javaRequest.getJavaOpts());

        //클래스 실행인 경우
        buildSingleOption(command, javaRequest.getClassName());

        //jar 실행인 경우
        buildBasicOption(command, "-jar", javaRequest.getJar());

        //arguments
        buildArgs(command, javaRequest.getArguments());
