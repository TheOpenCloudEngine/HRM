...
import org.opencloudengine.garuda.model.clientJob.HiveResult;
...
public class HiveTask extends InterceptorAbstractTask {
    ...
    public void runTask() throws Exception {
        this.hiveRequest = (HiveRequest) clientRequest;
        ...
        if (csv.exists()) {
            ...
            hiveResult.setCsv(FileCopyUtils.copyToString(new FileReader(csv)));
            clientJob.setClientResult(hiveResult);
        }
    }
